...
namespace Fintrak.Data.Basic
{
    ...
    public class CollateralTypeRepository : DataRepositoryBase<CollateralType>, ICollateralTypeRepository
    {
        ...
        protected override CollateralType AddEntity(BasicContext entityContext, CollateralType entity)
        {
            return entityContext.Set<CollateralType>().Add(entity);
        }

        protected override CollateralType UpdateEntity(BasicContext entityContext, CollateralType entity)
        {
        ...
        protected override IEnumerable<CollateralType> GetEntities(BasicContext entityContext)
        {
            return from e in entityContext.Set<CollateralType>()
                   select e;
        }

        protected override CollateralType GetEntity(BasicContext entityContext, int id)
        {
