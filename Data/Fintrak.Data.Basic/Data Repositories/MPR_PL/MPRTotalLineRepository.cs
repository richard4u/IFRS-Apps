...
namespace Fintrak.Data.Basic
{
    ...
    public class MPRTotalLineRepository : DataRepositoryBase<MPRTotalLine>, IMPRTotalLineRepository
    {
        ...
        protected override MPRTotalLine AddEntity(BasicContext entityContext, MPRTotalLine entity)
        {
            return entityContext.Set<MPRTotalLine>().Add(entity);
        }

        protected override MPRTotalLine UpdateEntity(BasicContext entityContext, MPRTotalLine entity)
        {
        ...
        protected override IEnumerable<MPRTotalLine> GetEntities(BasicContext entityContext)
        {
            return from e in entityContext.Set<MPRTotalLine>()
                   select e;
        }

        protected override MPRTotalLine GetEntity(BasicContext entityContext, int id)
        {
