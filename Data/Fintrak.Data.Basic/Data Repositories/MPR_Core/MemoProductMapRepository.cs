...
namespace Fintrak.Data.Basic
{
    ...
    public class MemoProductMapRepository : DataRepositoryBase<MemoProductMap>, IMemoProductMapRepository
    {
        ...
        protected override MemoProductMap AddEntity(BasicContext entityContext, MemoProductMap entity)
        {
            return entityContext.Set<MemoProductMap>().Add(entity);
        }

        protected override MemoProductMap UpdateEntity(BasicContext entityContext, MemoProductMap entity)
        {
        ...
        protected override IEnumerable<MemoProductMap> GetEntities(BasicContext entityContext)
        {
            return from e in entityContext.Set<MemoProductMap>()
                   select e;
        }

        protected override MemoProductMap GetEntity(BasicContext entityContext, int id)
        {
