...
namespace Fintrak.Data.Basic
{
    ...
    public class NonProductMapRepository : DataRepositoryBase<NonProductMap>, INonProductMapRepository
    {
        ...
        protected override NonProductMap AddEntity(BasicContext entityContext, NonProductMap entity)
        {
            return entityContext.Set<NonProductMap>().Add(entity);
        }

        protected override NonProductMap UpdateEntity(BasicContext entityContext, NonProductMap entity)
        {
        ...
        protected override IEnumerable<NonProductMap> GetEntities(BasicContext entityContext)
        {
            return from e in entityContext.Set<NonProductMap>()
                   select e;
        }

        protected override NonProductMap GetEntity(BasicContext entityContext, int id)
        {
