...
namespace Fintrak.Data.MPR
{
    ...
    public class PLIncomeReportRepository : DataRepositoryBase<PLIncomeReport>, IPLIncomeReportRepository
    {
        ...
        protected override PLIncomeReport AddEntity(MPRContext entityContext, PLIncomeReport entity)
        {
            return entityContext.Set<PLIncomeReport>().Add(entity);
        }

        protected override PLIncomeReport UpdateEntity(MPRContext entityContext, PLIncomeReport entity)
        {
        ...
        protected override IEnumerable<PLIncomeReport> GetEntities(MPRContext entityContext)
        {
            //return from e in entityContext.Set<PLIncomeReport>()
            //       select e;
        ...
        protected override PLIncomeReport GetEntity(MPRContext entityContext, int id)
        {
            var query = (from e in entityContext.Set<PLIncomeReport>()
                         where e.Id == id
                         select e);
