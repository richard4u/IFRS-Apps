...
namespace Fintrak.Data.MPR
{
    ...
    public class CustAccountRepository : DataRepositoryBase<CustAccount>, ICustAccountRepository
    {
        ...
        protected override CustAccount AddEntity(MPRContext entityContext, CustAccount entity)
        {
            return entityContext.Set<CustAccount>().Add(entity);
        }

        protected override CustAccount UpdateEntity(MPRContext entityContext, CustAccount entity)
        {
        ...
        protected override IEnumerable<CustAccount> GetEntities(MPRContext entityContext)
        {
            //return from e in entityContext.Set<CustAccount>()
            //       select e;
        ...
        protected override CustAccount GetEntity(MPRContext entityContext, int id)
        {
            var query = (from e in entityContext.Set<CustAccount>()
