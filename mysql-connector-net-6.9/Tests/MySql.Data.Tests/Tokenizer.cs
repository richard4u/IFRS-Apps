...
{
  public class Tokenizer : BaseFixture
  {
    ...
    {
      _fixture.execSQL("DROP TABLE IF EXISTS Test");
      _fixture.execSQL("CREATE TABLE Test(name VARCHAR(40))");

      MySqlCommand cmd = new MySqlCommand("INSERT INTO Test SET name='test -- test';", _fixture.conn);
      cmd.ExecuteNonQuery();
