...
{
  public class ScriptExecution : BaseFixture
  {
    ...
    protected override void Dispose(bool disposing)
    {
      ...
      for (int i = 0; i < 10; i++)
      {
        _fixture.execSQL("DROP PROCEDURE IF EXISTS spTest" + i);
      }
    ...
    {
      string connStr = _fixture.conn.ConnectionString.ToLowerInvariant();
    ...
    public void DelimiterInScriptV2()
    {
      ...
      MySqlScript script = new MySqlScript(_fixture.conn, sql.ToString());
      script.Execute();
    }
    ...
    public void EmptyLastLineWithScriptExecute()
    {
      ...
      MySqlScript script = new MySqlScript(_fixture.conn, sb.ToString());
    ...
    {
      MySqlScript script = new MySqlScript(_fixture.conn, "DELIMITER ;");
