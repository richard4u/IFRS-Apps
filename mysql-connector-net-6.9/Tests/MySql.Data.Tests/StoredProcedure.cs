...
{
  public class StoredProcedure : BaseFixture
  {
    ...
    public void ReturningResultset()
    {
      ...
      _fixture.execSQL("CREATE PROCEDURE spTest(val decimal(10,3)) begin select val; end");

      using (MySqlCommand cmd = new MySqlCommand("spTest", _fixture.conn))
      {
    ...
    public void NonQuery()
    {
      ...
      _fixture.execSQL(@"CREATE PROCEDURE spTest(IN value INT) 
    ...
    public void NoBatch()
    {
      ...
      //try
      //{
        MySqlCommand cmd = new MySqlCommand("spTest;select * from Test", _fixture.conn);
        cmd.CommandType = CommandType.StoredProcedure;
    ...
    public void WrongParameters()
    {
      ...
      _fixture.execSQL("CREATE PROCEDURE spTest(p1 INT) BEGIN SELECT 1; END");
      try
      {
        MySqlCommand cmd = new MySqlCommand("spTest", _fixture.conn);
        cmd.CommandType = CommandType.StoredProcedure;
    ...
    public void NoInOutMarker()
    {
      ...
      // create our procedure
      _fixture.execSQL("CREATE PROCEDURE spTest( valin varchar(50) ) BEGIN  SELECT valin;  END");
    ...
    public void ExecuteScalar2()
    {
      ...
      // create our procedure
      _fixture.execSQL("CREATE PROCEDURE spTest() " +
    ...
    public void NoDefaultDatabase()
    {
      ...
      // create our procedure
      _fixture.execSQL("CREATE PROCEDURE spTest() BEGIN  SELECT 4; END");

      string newConnStr = _fixture.GetConnectionString(false);
      using (MySqlConnection c = new MySqlConnection(newConnStr))
      {
        c.Open();
        MySqlCommand cmd2 = new MySqlCommand(String.Format("use `{0}`", _fixture.database0), c);
        ...
        cmd2.CommandText = String.Format("use `{0}`", _fixture.database1);
        cmd2.ExecuteNonQuery();

        cmd.CommandText = String.Format("`{0}`.spTest", _fixture.database0);
    ...
    */
    ...
    public void DecimalAsParameter()
    {
      ...
      _fixture.execSQL("CREATE PROCEDURE spTest(IN d DECIMAL(19,4)) BEGIN SELECT d; END");
    ...
    public void ParmWithCharacterSet()
    {
      ...
      _fixture.execSQL("CREATE PROCEDURE spTest(P longtext character set utf8) " +
        "BEGIN SELECT P; END");
    ...
    public void SpecialCharacters()
    {
      ...
      _fixture.execSQL("SET sql_mode=ANSI_QUOTES");
      try
      {
        _fixture.execSQL("CREATE PROCEDURE spTest(\"@Param1\" text) BEGIN SELECT \"@Param1\"; END");
    ...
    public void CallingSPWithPrepare()
    {
      ...
      _fixture.execSQL("CREATE PROCEDURE spTest(P int) BEGIN SELECT P; END");
    ...
    public void MultipleRecords()
    {
      ...
      _fixture.execSQL("CREATE TABLE Test (id INT, name VARCHAR(20))");
      _fixture.execSQL("CREATE PROCEDURE spTest(id int, str VARCHAR(45)) " +
    ...
    public void Bug16788()
    {
      ...
      _fixture.execSQL("CREATE TABLE Test (id integer(9), state varchar(2))");
      _fixture.execSQL("CREATE PROCEDURE spTest(IN p1 integer(9), IN p2 varchar(2)) " +
        "BEGIN " +
        "INSERT INTO Test (id, state) VALUES (p1, p2); " +
        "END");

      MySqlCommand cmd = _fixture.conn.CreateCommand();
      cmd.CommandType = CommandType.StoredProcedure;
    ...
    public void ProcedureCache()
    {
      ...
      using (MySqlConnection c = new MySqlConnection(connStr))
      {
        ...
        for (int x = 0; x < 10; x++)
        {
          _fixture.execSQL("CREATE PROCEDURE spTest" + x + "() BEGIN SELECT 1; END");
    ...
    public void Bug20581()
    {
      ...
      MySqlCommand command = new MySqlCommand("spTest", _fixture.conn);
    ...
    public void PreparedReader()
    {
      ...
      _fixture.execSQL("CREATE TABLE  Test (id int(10) unsigned NOT NULL default '0', " +
         "val int(10) unsigned default NULL, PRIMARY KEY (id)) " +
         "ENGINE=InnoDB DEFAULT CHARSET=utf8");
      _fixture.execSQL("CREATE PROCEDURE spTest (IN pp INTEGER) " +
            "select * from Test where id > pp ");

      MySqlCommand c = new MySqlCommand("spTest", _fixture.conn);
    ...
    public void TurkishStoredProcs()
    {
      ...
      _fixture.execSQL("CREATE PROCEDURE spTest(IN p_paramname INT) BEGIN SELECT p_paramname; END");
    ...
    public void ProcEnumParamTest()
    {
      ...
      _fixture.execSQL("CREATE TABLE Test(str VARCHAR(50), e ENUM ('P','R','F','E'), i INT(6))");
      _fixture.execSQL("CREATE PROCEDURE spTest(IN p_enum ENUM('P','R','F','E')) BEGIN " +
    ...
    public void GetSchema()
    {
      ...
      _fixture.execSQL("CREATE PROCEDURE spTest() BEGIN SELECT * FROM Test; END");
    ...
    public void UsingUInt64AsParam()
    {
      ...
      _fixture.execSQL(@"CREATE TABLE Test(f1 bigint(20) unsigned NOT NULL,
            PRIMARY KEY(f1)) ENGINE=InnoDB DEFAULT CHARSET=utf8");

      _fixture.execSQL(@"CREATE PROCEDURE spTest(in _val bigint unsigned)
    ...
    public void CatalogWithHyphens()
    {
      ...
      Assert.True(_fixture.database0.IndexOf('-') != -1);

      MySqlCommand cmd = new MySqlCommand("CREATE PROCEDURE spTest() BEGIN SELECT 1; END", _fixture.conn);
      cmd.ExecuteNonQuery();
    ...
    public void ComplexDefinition()
    {
      ...
      _fixture.execSQL(@"CREATE PROCEDURE `spTest`() NOT DETERMINISTIC
    ...
    public void AmbiguousColumns()
    {
      ...
      _fixture.execSQL("CREATE TABLE t1 (id INT)");
      _fixture.execSQL("CREATE TABLE t2 (id1 INT, id INT)");
      _fixture.execSQL(@"CREATE PROCEDURE spTest() BEGIN SELECT * FROM t1; 
    ...
    public void SPWithSpaceInParameterType()
    {
      ...
      _fixture.execSQL("CREATE PROCEDURE spTest(myparam decimal  (8,2)) BEGIN SELECT 1; END");
    ...
    private void ParametersInReverseOrderInternal(bool isOwner)
    {
      ...
      _fixture.execSQL(@"CREATE PROCEDURE spTest(IN p_1 VARCHAR(5), IN p_2 VARCHAR(5))
    ...
    {
      if (_fixture.Version < new Version(5, 0)) return;
      if (_fixture.Version > new Version(6, 0, 6)) return;

      _fixture.execSQL(@"CREATE  PROCEDURE spTest (id INT, name VARCHAR(20))
    ...
    public void ProcedureCacheMiss()
    {
      ...
      string connStr = _fixture.GetConnectionString(true) + ";procedure cache size=25";
      using (MySqlConnection c = new MySqlConnection(connStr))
      {
        c.Open();
        MySqlCommand cmd = new MySqlCommand("spTest", c);
        ...
        _fixture.execSQL("CREATE PROCEDURE spTest(id INT, id2 INT, id3 INT) BEGIN SELECT 1; END");
    ...
    {
      if (_fixture.Version < new Version(5, 5, 3)) return;
    ...
    {
      _fixture.execSQL("CREATE PROCEDURE GetCount() BEGIN SELECT 5; END");

      MySqlCommand cmd = new MySqlCommand("GetCount", _fixture.conn);
      cmd.CommandType = CommandType.Text;
