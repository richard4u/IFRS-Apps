...
(function () {
    ...
    function CategoryTransferPriceListController($scope, $state, viewModelHelper, validator) {
        ...
        var initialize = function () {
            ...
            if (vm.init === false) {
                vm.viewModelHelper.apiGet('api/categorytransferprice/availablecategorytransferprice', null,
                   function (result) {
        ...
        var InitialGrid = function () {
            setTimeout(function () {
                ...
                // data export
                if ($('#categoryTransferPriceTable').length > 0) {
                    var exportTable = $('#categoryTransferPriceTable').DataTable({
