...
(function () {
    ...
    angular
        .module("fintrak")
        .controller("OpexGLMappingEditController",
                    ['$scope', '$window', '$state', '$stateParams', 'viewModelHelper', 'validator',
                        OpexGLMappingEditController]);

    function OpexGLMappingEditController($scope, $window, $state, $stateParams, viewModelHelper, validator) {
        var vm = this;
        vm.viewModelHelper = viewModelHelper;
        vm.parentController = $scope.$parent;

        vm.module = 'Core';
        vm.view = 'opexglmapping-edit-view';
        ...
        var initialize = function () {
            if (vm.init === false) {
                ...
                if ($stateParams.glmappingId !== 0) {
                    ...
                    vm.viewModelHelper.apiGet('api/opexglmapping/getglmapping/' + $stateParams.glmappingId, null,
                   function (result) {
        ...
        vm.save = function () {
            ...
            if (vm.viewModelHelper.modelIsValid) {
                ...
                vm.viewModelHelper.apiPost('api/opexglmapping/updateglmapping', vm.glMapping,
               function (result) {
                   
                   $state.go('opex-opexglmapping-list');
               },
               function (result) {
                   toastr.error(result.data, 'Fintrak');
               }, null);
        ...
        vm.delete = function () {
            ...
            if (deleteFlag) {
                vm.viewModelHelper.apiPost('api/opexglmapping/deleteglmapping', vm.glMapping.GLMappingId,
              function (result) {
        ...
        var getCaptions = function () {
            vm.viewModelHelper.apiGet('api/opexglmapping/getsubcaptions/0', null,
                 function (result) {
        ...
        var getSubCaptions = function () {
            vm.viewModelHelper.apiGet('api/opexglmapping/getsubcaptions/1', null,
                 function (result) {
        ...
        var getSubCaption1s = function () {
            vm.viewModelHelper.apiGet('api/opexglmapping/getsubcaptions/2', null,
                 function (result) {
        ...
        var getSubCaption2s = function () {
            vm.viewModelHelper.apiGet('api/opexglmapping/getsubcaptions/3', null,
                 function (result) {
        ...
        var getSubCaption3s = function () {
            vm.viewModelHelper.apiGet('api/opexglmapping/getsubcaptions/4', null,
                 function (result) {
        ...
        var getSubCaption4s = function () {
            vm.viewModelHelper.apiGet('api/opexglmapping/getsubcaptions/5', null,
                 function (result) {
