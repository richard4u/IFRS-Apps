...
{
    public class IncomeRelated
    {
        #region  Income Breakdown stored procedure
        public DataTable IncomeBreakdown(DateTime RunDate, string MainCaption, string ReportType, string Company, string Currency, string BudgetType)
        {
        ...
        #region  Income GLBreakdown stored procedure
        public DataTable IncomeGLBreakdown(DateTime RunDate, string MainCaption, string ReportType, string SubCaption, string Company, string Currency, string BudgetType)
        {
            DbConnection Connection = new DbConnection();
