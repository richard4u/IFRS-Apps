...
(function () {
    ...
    angular
        .module("fintrak")
        .controller("FinstatDashboardController",
            ['$scope', '$state', 'viewModelHelper', 'validator',
                FinstatDashboardController]);

    function FinstatDashboardController($scope, $state, viewModelHelper, validator) {
        var vm = this;
