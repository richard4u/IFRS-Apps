...
(function () {
    ...
    angular
        .module("fintrak")
        .controller("CheckDataAvailabilityController",
        ['$scope', '$window','$state', 'viewModelHelper', 'validator',
                        CheckDataAvailabilityController]);

    function CheckDataAvailabilityController($scope, $state, $window, viewModelHelper, validator) {
        var vm = this;
        vm.viewModelHelper = viewModelHelper;
        vm.parentController = $scope.$parent;

        vm.module = 'CheckDataAvailability';
        vm.view = 'checkdataavailability-list-view';
        vm.viewName = 'Staging Data | Check Data Availability';
        ...
        var initialize = function(){
            ...
            if (vm.init === false) {
                vm.viewModelHelper.apiGet('api/checkdataavailability/availabledatacheck', null,
                   function (result) {
        ...
        vm.rundatacheck = function () {
           ...
           vm.viewModelHelper.apiPost('api/checkdataavailability/checkstagingbyrundate', params,
                function (result) {
