...
(function () {
    ...
    function GLMappingEditController($scope, $window, $state, $stateParams, viewModelHelper, validator, objectPropertyValidationService) {
        var vm = this;
        ...
        var initialize = function() {
            if (vm.init == false) {
                ...
                if ($stateParams.glmappingId != 0) {
                    ...
                    vm.viewModelHelper.apiGet('api/glmapping/getglmapping/' + $stateParams.glmappingId,
                        null,
                        function(result) {
                            vm.glMapping = result.data;
                            vm.SubPosition = result.data.SubPosition;
                            initialView();
                            vm.init === true;
        ...
        var initialView = function() {
            getMainCaptions();
            getSubCaptionbyCaptionCode(vm.glMapping.CaptionCode);
        ...
        vm.save = function () {
            ...
            if (vm.viewModelHelper.modelIsValid) {
                if (objectPropertyValidationService.suspeciousInputDataDetectedFunc(vm.glMapping) == false) {
        ...
        vm.delete = function() {
            ...
            if (deleteFlag) {
                vm.viewModelHelper.apiPost('api/glmapping/deleteglmapping',
                    vm.glMapping.GLMappingId,
                    function(result) {
        ...
        var getMainCaptions = function() {
            vm.viewModelHelper.apiGet('api/registry/getmainCaptions/' + vm.glMapping.ReportType,
                null,
                function(result) {
        ...
        var getSubCaptions = function() {
            vm.viewModelHelper.apiGet('api/glmapping/getsubcaptions/0/0',
                null,
                function(result) {
        ...
        var getSubCaption1s = function(caption) {
            vm.viewModelHelper.apiGet('api/glmapping/getsubsubcaptions/' + caption,
                null,
                function(result) {
                    vm.subCaption1s = result.data;
                },
        ...
        //    vm.viewModelHelper.apiGet('api/glmapping/getsubcaptions/2/0',
        //        null,
        //        function(result) {
        ...
        //    vm.viewModelHelper.apiGet('api/glmapping/getsubcaptions/4/0',
        //        null,
        //        function(result) {
        ...
        var getSubPosition = function (caption) {
            vm.viewModelHelper.apiGet('api/glmapping/getsubcaptionposition/' + caption,
                null,
                function (result) {
                    vm.subTypes = result.data;
                    vm.SubPosition = result.data[0].Value;                  
                },
                function (result) {
                    vm.subCaption1s = [];
                    toastr.error('Fail to load SubCaption Position.', 'Fintrak');
