...
(function () {
    ...
    function RegistryEditController($scope, $window, $state, $stateParams, viewModelHelper, validator, objectPropertyValidationService) {
        var vm = this;
        ...
        var setupRules = function() {
            ...
            registryRules.push(new validator.PropertyRule("Company",
                {
            ...
            if (vm.init == false) {
                ...
                if ($stateParams.registryId != 0) {
                   ...
                   function (result) {
                    ...
                    vm.registry = { Caption: '', FinType: '', FinSubType: '', Position: 1, Class: 1, flag: $stateParams.flag, Active: true };
            }
        }
        ...
        vm.save = function () {
            ...
            if (vm.viewModelHelper.modelIsValid) {
                if (objectPropertyValidationService.suspeciousInputDataDetectedFunc(vm.registry) == false) {
        ...
        var getParents = function () {
            vm.viewModelHelper.apiGet('api/registry/availableregistrys/' + $stateParams.flag, null,
                 function (result) {
