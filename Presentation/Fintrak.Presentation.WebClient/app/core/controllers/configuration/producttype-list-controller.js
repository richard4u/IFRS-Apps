...
(function () {
    ...
    function ProductTypeListController($scope,$state, viewModelHelper, validator) {
        var vm = this;
        vm.viewModelHelper = viewModelHelper;
        vm.parentController = $scope.$parent;

        vm.module = 'Core';
        vm.view = 'producttype-list-view';
        vm.viewName = 'Product Types';
        ...
        var InitialGrid = function () {
            setTimeout(function () {
                ...
                if ($('#productTypeTable').length > 0) {
                    var exportTable = $('#productTypeTable').DataTable({
