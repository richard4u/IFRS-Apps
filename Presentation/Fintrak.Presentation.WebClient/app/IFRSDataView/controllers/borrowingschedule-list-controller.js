...
(function () {
    ...
    function BorrowingScheduleListController($scope, $state, viewModelHelper, validator) {
        ...
        var getRefNos = function () {
            vm.viewModelHelper.apiGet('api/borrowingschedule/getrefnos', null,
                function (result) {
        ...
        vm.load = function () {
            ...
            if (vm.RefNo === '') {
                ...
                vm.viewModelHelper.apiGet('api/borrowingschedule/getborrowingschedule?RefNo=' + vm.RefNo + '&Date=' + vm.Date.toLocaleDateString('sq-AL'), null,
                    function (result) {
        ...
        vm.exportAllData = function (split) {
            ...
            xhr.open('GET', 'api/borrowingschedule/getborrowingschedule?RefNo=' + split + 'ExportData ' + vm.RefNo + '&Date=' + Date, true);
