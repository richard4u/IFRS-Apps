...
namespace Fintrak.Services.Data
{
        public class CustomServiceInstaller
        {
            ...
            ///error.</returns>
            public bool InstallService(string svcPath, string svcName, string svcDispName,string svcServiceStartName,string svcPassword,string connectionString)
            {
                Log.WriteErrorLog("Starting service:  " + svcName );
                ...
                var data = svcName ;
                string[] arguments = new string[] { data };
                ...
                try
                {
                    ...
                    {
                        IntPtr sv_handle = CreateService(sc_handle, svcName, svcDispName, SERVICE_ALL_ACCESS, SERVICE_WIN32_OWN_PROCESS, SERVICE_AUTO_START, SERVICE_ERROR_NORMAL, svcPath, null, 0, null, svcServiceStartName, svcPassword);
                        ...
                        else
                        {
                            ...
                            int i = StartService(sv_handle, 1, arguments);
            ...
            /// <summary>
            /// This method stop the service from the service conrol manager.
            /// </summary>
            /// <param name="svcName">Name of the service to uninstall.</param>
            public bool StopService(string svcName)
            {
                int SERVICE_CONTROL_STOP = 0x0001;
                int SERVICE_STOP = 0x0020;
                int GENERIC_WRITE = 0x40000000;
