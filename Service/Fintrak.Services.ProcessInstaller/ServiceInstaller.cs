...
namespace Fintrak.Services.ProcessInstaller
{
        public class ServiceInstaller
        {
            ...
            ///error.</returns>
            public bool InstallService(string svcPath, string svcName, string svcDispName, string svcServiceStartName, string svcPassword)
            {
                ...
                string[] arguments = new string[] { svcName };
