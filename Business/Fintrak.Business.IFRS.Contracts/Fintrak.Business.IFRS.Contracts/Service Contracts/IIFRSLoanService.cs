...
namespace Fintrak.Business.IFRS.Contracts
{
    ...
    public interface IIFRSLoanService : IServiceContract
    {
        ...
        [OperationContract]
        [TransactionFlow(TransactionFlowOption.Allowed)]
        void DeleteLoanSetupIdList(string loanSetupId);
        ...
        #region CollateralreliazationPeriod
        ...
        [OperationContract]
        [TransactionFlow(TransactionFlowOption.Allowed)]
        BondSummary UpdateBondSummary(BondSummary bondSummary);

        [OperationContract]
        [TransactionFlow(TransactionFlowOption.Allowed)]
        void DeleteBondSummary(int BondId);

        [OperationContract]
        [FaultContract(typeof(NotFoundException))]
        BondSummary GetBondSummary(int BondId);

        [OperationContract]
        BondSummary[] GetAllBondSummarys();
