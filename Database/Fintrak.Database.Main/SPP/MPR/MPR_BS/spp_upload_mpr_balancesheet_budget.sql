Create proc spp_upload_mpr_balancesheet_budget
(
...
If Exists (SELECT CompanyCode, TeamCode, Year, CaptionName, Mth1, Mth2, Mth3, Mth4, Mth5, Mth6, Mth7, Mth8, Mth9, Mth10, Mth11, Mth12, 
Active, Deleted, CreatedBy, CreatedOn, UpdatedBy, UpdatedOn
FROM            mpr_balancesheet_budget 
where year = @Year and CaptionName = @Caption and TeamCode = @Mis and CompanyCode = @CompanyCode)
Begin
	Update mpr_balancesheet_budget 
	SET Mth1 = @Jan,
	Mth2 = @Feb,
	Mth3 = @Mar,
	Mth4 = @Apr,
...
Else
Begin
	Insert into mpr_balancesheet_budget(CompanyCode,CaptionName, TeamCode, Year, Mth1, Mth2, Mth3, Mth4, Mth5, Mth6, Mth7, Mth8,
