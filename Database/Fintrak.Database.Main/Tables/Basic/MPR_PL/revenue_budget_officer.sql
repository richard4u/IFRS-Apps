CREATE TABLE [dbo].[mpr_revenue_budget_officer]
(
	[RevenueBudgetOffId] INT NOT NULL IDENTITY,
    ...
    CONSTRAINT [PK_mpr_revenue_budget_officer] PRIMARY KEY ([RevenueBudgetOffId])  
)
