CREATE TABLE [dbo].[mpr_balancesheet_budget]
(
	[BalancesheetBudgetId] INT NOT NULL IDENTITY,
    ...
    CONSTRAINT [PK_mpr_balancesheet_budget] PRIMARY KEY ([BalancesheetBudgetId])  
)
