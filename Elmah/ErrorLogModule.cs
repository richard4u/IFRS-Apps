...
namespace Elmah
{
    ...
    public class ErrorLogModule : HttpModuleBase, IExceptionFiltering
    {
        ...
        public virtual void LogException(Exception e, HttpContextBase context)
        {
            if (e == null)
            ...
            try
            {
                ...
                if (string.IsNullOrEmpty(connection))
                    connection = System.Configuration.ConfigurationManager.ConnectionStrings["FintrakLogDBConnection"].ConnectionString;
                MySqlErrorLog mysqlerrorlog = new MySqlErrorLog(connection);
                mysqlerrorlog.Log(error);
