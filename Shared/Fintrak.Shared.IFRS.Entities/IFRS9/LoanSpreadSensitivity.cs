...
{
    public partial class LoanSpreadSensitivity : EntityBase, IIdentifiableEntity
    {

        [DataMember]
        [Browsable(false)]
        public int LoanSpreadSensitivityId { get; set; }
        ...
        //[DataMember]
        //public double Significant { get; set; }
        ...
        public int EntityId
        {
            get
            {
                return LoanSpreadSensitivityId;
            }
        }
    }
}
