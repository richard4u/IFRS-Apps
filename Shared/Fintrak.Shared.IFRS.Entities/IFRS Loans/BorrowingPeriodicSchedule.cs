...
{
    public partial class BorrowingPeriodicSchedule : EntityBase, IIdentifiableEntity
    {
        [DataMember]
        [Browsable (false)]
        ...
        [DataMember]
        public double Amt_Intexp_Pay { get; set; }
        ...
        [DataMember]
        public double AMAmt_Intexp_Pay { get; set; }
