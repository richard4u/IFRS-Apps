...
{
    public class IFRSRegistry : ObjectBase
    {
        int _RegistryId;
        string _Code;
        string _Caption;
        ...
        class IFRSRegistryValidator : AbstractValidator<IFRSRegistry>
        {
            public IFRSRegistryValidator()
            {
        ...
        {
            return new IFRSRegistryValidator();
        }
    }
}
