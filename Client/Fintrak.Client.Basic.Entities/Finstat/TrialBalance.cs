...
{
    public class TrialBalance : ObjectBase
    {
        int _TrialBalanceId;
        string _BranchCode;
        string _GLCode;
        ...
        class TrialBalanceValidator : AbstractValidator<TrialBalance>
        {
            public TrialBalanceValidator()
            {
        ...
        {
            return new TrialBalanceValidator();
        }
    }
}
