...
{
    public class BalanceSheetBudget : ObjectBase
    {
        int _BudgetId;
        string _CaptionName;
        string _Year;
        ...
        class BalanceSheetBudgetValidator : AbstractValidator<BalanceSheetBudget>
        {
            public BalanceSheetBudgetValidator()
            {
        ...
        {
            return new BalanceSheetBudgetValidator();
        }
    }
}
