...
{
    public class RevenueIncExp : TransactionObjectDecimalBase
    {
        int _RevenueIncExpId;
        ...
        public int RevenueIncExpId
        {
            get { return _RevenueIncExpId; }
            set
            {
                if (_RevenueIncExpId != value)
                {
                    _RevenueIncExpId = value;
                    OnPropertyChanged(() => RevenueIncExpId);
                }
            }
        }
        ...
        class RevenueIncExpValidator : AbstractValidator<RevenueIncExp>
        {
            public RevenueIncExpValidator()
            {
        ...
        {
            return new RevenueIncExpValidator();
        }
    }
}
