...
{
    public class CapexEntry : TransactionObjectDecimalBase
    {
        int _CapexEntryId;
        ...
        public int CapexEntryId
        {
            get { return _CapexEntryId; }
            set
            {
                if (_CapexEntryId != value)
                {
                    _CapexEntryId = value;
                    OnPropertyChanged(() => CapexEntryId);
                }
            }
        }
        ...
        class CapexEntryValidator : AbstractValidator<CapexEntry>
        {
            public CapexEntryValidator()
            {
        ...
        {
            return new CapexEntryValidator();
        }
    }
}
