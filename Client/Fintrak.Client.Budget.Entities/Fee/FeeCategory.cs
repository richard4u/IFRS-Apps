...
{
    public class FeeCategory : ObjectBase
    {
        int _FeeCategoryId;
        string _Code;
        string _Name;
        ...
        public int FeeCategoryId
        {
            ...
            set
            {
                if (_FeeCategoryId != value)
                {
                    _FeeCategoryId = value;
                    OnPropertyChanged(() => FeeCategoryId);
                }
            }
        }
        ...
        class FeeCategoryValidator : AbstractValidator<FeeCategory>
        {
            public FeeCategoryValidator()
            {
        ...
        {
            return new FeeCategoryValidator();
        }
    }
}
