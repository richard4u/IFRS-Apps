...
{
    public class RevenueBudgetOfficer : ObjectBase
    {
        int _BudgetId;
        string _CaptionName;
        string _Year;
        ...
        class RevenueBudgetOfficerValidator : AbstractValidator<RevenueBudgetOfficer>
        {
            public RevenueBudgetOfficerValidator()
            {
        ...
        {
            return new RevenueBudgetOfficerValidator();
        }
    }
}
