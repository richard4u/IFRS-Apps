...
{
    public class BSINOtherInformationTotalLine : ObjectBase
    {
        int _BSINOtherInformationTotalLineId;
        string _Segment;
        ...
        public int BSINOtherInformationTotalLineId
        {
            get { return _BSINOtherInformationTotalLineId; }
            set
            {
                if (_BSINOtherInformationTotalLineId != value)
                {
                    _BSINOtherInformationTotalLineId = value;
                    OnPropertyChanged(() => BSINOtherInformationTotalLineId);
                }
            }
        }
        ...
        class BSINOtherInformationTotalLineValidator : AbstractValidator<BSINOtherInformationTotalLine>
        {
            public BSINOtherInformationTotalLineValidator()
            {
        ...
        {
            return new BSINOtherInformationTotalLineValidator();
        }
    }
}
