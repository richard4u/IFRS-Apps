...
{
    public class BalanceSheetBudgetOfficer : ObjectBase
    {
        int _BudgetId;
        string _CaptionName;
        string _Year;
        ...
        class BalanceSheetBudgetOfficerValidator : AbstractValidator<BalanceSheetBudgetOfficer>
        {
            public BalanceSheetBudgetOfficerValidator()
            {
        ...
        {
            return new BalanceSheetBudgetOfficerValidator();
        }
    }
}
