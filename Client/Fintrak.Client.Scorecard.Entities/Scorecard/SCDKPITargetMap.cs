...
{
    public class SCDKPITargetMap : ObjectBase
    {
        int _MapId;
        string _KPICode;
        string _Formula;
        ...
        class SCDKPITargetMapValidator : AbstractValidator<SCDKPITargetMap>
        {
            public SCDKPITargetMapValidator()
            {
        ...
        {
            return new SCDKPITargetMapValidator();
        }
    }
}
