...
{
    public class BorrowingPeriodicSchedule : ObjectBase
    {
        int _Id;
        string _RefNo;
        int _Num_Pmt;
        ...
        public double Amt_Pmt
        {
            ...
            set
            {
                ...
                {
                    _Amt_Pmt = value;
                    OnPropertyChanged(() => Amt_Pmt);
                }
            }
        }


        public double Amt_Intexp_Pay
        {
            get { return _Amt_Intexp_Pay; }
            set
            {
                if (_Amt_Intexp_Pay != value)
                {
                    _Amt_Intexp_Pay = value;
                    OnPropertyChanged(() => Amt_Intexp_Pay);
                }
            }
        }
        ...
        public double AMAmt_Intexp_Pay
        {
            get { return _AMAmt_Intexp_Pay; }
            set
            {
                if (_AMAmt_Intexp_Pay != value)
                {
                    _AMAmt_Intexp_Pay = value;
                    OnPropertyChanged(() => AMAmt_Intexp_Pay);
                }
            }
        }
        ...
        class BorrowingPeriodicScheduleValidator : AbstractValidator<BorrowingPeriodicSchedule>
        {
            public BorrowingPeriodicScheduleValidator()
            {
        ...
        {
            return new BorrowingPeriodicScheduleValidator();
        }
    }
}
