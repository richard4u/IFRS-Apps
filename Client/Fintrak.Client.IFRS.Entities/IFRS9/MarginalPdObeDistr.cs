...
{
    public class MarginalPdObeDistr : ObjectBase
    {
        ...
        class MarginalPdObeDistrValidator : AbstractValidator<MarginalPdObeDistr>
        {
            public MarginalPdObeDistrValidator(){
        ...
        {
            return new MarginalPdObeDistrValidator();
        }
