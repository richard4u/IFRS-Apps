...
{
    public class BondsECLResult : ObjectBase
    {
        int _ID;
        string _AccountNo;
        string _RefNo;
        ...
        class BondsECLResultValidator : AbstractValidator<BondsECLResult>
        {
            public BondsECLResultValidator()
            {
        ...
        {
            return new BondsECLResultValidator();
        }
    }
}
