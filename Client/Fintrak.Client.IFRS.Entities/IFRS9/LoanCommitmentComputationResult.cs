...
{
    public class LoanCommitmentComputationResult : ObjectBase
    {
        int _LoanCommitmentComputationResult_Id;
        string _Refno;
        ...
        public int LoanCommitmentComputationResult_Id
        {
            get { return _LoanCommitmentComputationResult_Id; }
            set
            {
                if (_LoanCommitmentComputationResult_Id != value)
                {
                    _LoanCommitmentComputationResult_Id = value;
                    OnPropertyChanged(() => LoanCommitmentComputationResult_Id);
                }
            }
        }
        ...
        class LoanCommitmentComputationResultValidator : AbstractValidator<LoanCommitmentComputationResult>
        {
            public LoanCommitmentComputationResultValidator()
            {
        ...
        {
            return new LoanCommitmentComputationResultValidator();
        }
    }
}
