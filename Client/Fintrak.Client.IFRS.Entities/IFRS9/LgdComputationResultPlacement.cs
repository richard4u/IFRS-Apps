...
{
    public class LgdComputationResultPlacement : ObjectBase
    {
        int _Id;
        string _Refno;
        string _Currency;
        ...
        class LgdComputationResultPlacementValidator : AbstractValidator<LgdComputationResultPlacement>
        {
            public LgdComputationResultPlacementValidator()
            {
        ...
        {
            return new LgdComputationResultPlacementValidator();
        }
    }
}
