...
{
    public class ODEclComputationResult : ObjectBase{
        ...
        class ODEclComputationResultValidator : AbstractValidator<ODEclComputationResult>
        {
            public ODEclComputationResultValidator(){
        ...
        {
            return new ODEclComputationResultValidator();
        }
