...
{
    public class OverdraftMonthlyEAD : ObjectBase
    {
        int _Id;
        string _AccountNo;
        string _RefNo;
       ...
       public DateTime date_pmt
        ...
        class OverdraftMonthlyEADValidator : AbstractValidator<OverdraftMonthlyEAD>
        {
            public OverdraftMonthlyEADValidator()
            {
        ...
        {
            return new OverdraftMonthlyEADValidator();
        }
    }
}
