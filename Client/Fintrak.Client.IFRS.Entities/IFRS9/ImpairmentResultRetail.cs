...
{
    public class ImpairmentResultRetail : ObjectBase
    {
        int _Impairment_Id;
        string _Account_No;
        ...
        class ImpairmentResultRetailValidator : AbstractValidator<ImpairmentResultRetail>
        {
            public ImpairmentResultRetailValidator()
            {
        ...
        {
            return new ImpairmentResultRetailValidator();
        }
    }
}
