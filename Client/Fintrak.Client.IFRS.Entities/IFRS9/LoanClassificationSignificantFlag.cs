...
{
    public class LoanClassificationSICRSignFlag : ObjectBase
    {
        ...
        public int SICR_ParamID
        {
            get { return _SICR_ParamID; }
            set {
                if (_SICR_ParamID != value) {
                    _SICR_ParamID = value;
                    OnPropertyChanged(() => SICR_ParamID);
                }
            }
        }
        public bool Active {
        ...
        class LoanClassificationSICRSignFlagValidator : AbstractValidator<LoanClassificationSICRSignFlag>{
            public LoanClassificationSICRSignFlagValidator(){
              //RuleFor(obj => obj.LoanClassificationId).NotEmpty().WithMessage("LoanClassificationId is required.");
            }
        }

        protected override IValidator GetValidator(){
            return new LoanClassificationSICRSignFlagValidator();
        }
    }
}
