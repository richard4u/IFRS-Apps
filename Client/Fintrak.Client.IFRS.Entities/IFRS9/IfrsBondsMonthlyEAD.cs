...
{
    public class IfrsBondsMonthlyEAD : ObjectBase
    {
        int _Id;
        string _AccountNo;
        string _RefNo;
    ...
    public int Id
    {
      ...
      set
      {
        ...
        class IfrsBondMonthlyEADValidator : AbstractValidator<IfrsBondsMonthlyEAD>
        {
            public IfrsBondMonthlyEADValidator()
            {
        ...
        {
            return new IfrsBondMonthlyEADValidator();
        }
    }
}
