...
{
    public class ObeLGDComptResult : ObjectBase
    {
        ...
        class ObeLGDComptResultValidator : AbstractValidator<ObeLGDComptResult>
        {
            public ObeLGDComptResultValidator(){
        ...
        {
            return new ObeLGDComptResultValidator();
        }
