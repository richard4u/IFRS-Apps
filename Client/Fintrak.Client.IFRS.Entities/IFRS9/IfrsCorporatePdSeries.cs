...
{
    public class IfrsCorporatePdSeries : ObjectBase
    {
        int _Sno;
        string _CustID;
        string _Rating;
        ...
        public double SurvivalPD_BEST
        {
            get { return _SurvivalPD_BEST; }
            set
            {
                if (_SurvivalPD_BEST != value)
                {
                    _SurvivalPD_BEST = value;
                    OnPropertyChanged(() => SurvivalPD_BEST);
                }
            }
        }
        ...
        class IfrsCorporatePdSeriesValidator : AbstractValidator<IfrsCorporatePdSeries>
        {
            public IfrsCorporatePdSeriesValidator()
            {
            }
        }
        ...
        {
            return new IfrsCorporatePdSeriesValidator();
        }
    }
}
