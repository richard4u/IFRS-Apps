...
{
    public class LocalBondSpread : ObjectBase
    {
        int _ID;
        DateTime _ConDate;
        double _ZeroRate;
        ...
        class LocalBondSpreadValidator : AbstractValidator<LocalBondSpread>
        {
            public LocalBondSpreadValidator()
            {
        ...
        {
            return new LocalBondSpreadValidator();
        }
    }
}
