...
{
    public class MarginalPDDistribution : ObjectBase
    {
        int _ID;
        string _AccountNo;
        string _Refno;
        ...
        class MarginalPDDistributionValidator : AbstractValidator<MarginalPDDistribution>
        {
            public MarginalPDDistributionValidator()
            {
        ...
        {
            return new MarginalPDDistributionValidator();
        }
    }
}
