...
{
    public class ObeEclComputation : ObjectBase
    {
        int _ID;
        string _AccountNo;
        string _Refno;
        ...
        class ObeEclComputationValidator : AbstractValidator<ObeEclComputation>
        {
            public ObeEclComputationValidator(){
        ...
        {
            return new ObeEclComputationValidator();
        }
