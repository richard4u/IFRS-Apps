...
{
    public class IfrsProjectedCummDefaultFrq : ObjectBase
    {
        int _Id;
        string _ProductType;
        string _sub_type;
    ...
    public bool Active
        ...
        class IfrsProjectedCummDefaultFrqValidator : AbstractValidator<IfrsProjectedCummDefaultFrq>
        {
            public IfrsProjectedCummDefaultFrqValidator()
            {
        ...
        {
            return new IfrsProjectedCummDefaultFrqValidator();
        }
    }
}
