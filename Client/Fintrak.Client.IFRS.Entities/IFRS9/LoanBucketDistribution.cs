...
{
    public class LoanBucketDistribution : ObjectBase
    {
        int _LoanBucketDistributionId;
        string _RefNo;
        string _AccountNo;
        string _Sector;
        string _Rating;
        ...
        public int LoanBucketDistributionId
        {
            get { return _LoanBucketDistributionId; }
            set
            {
                if (_LoanBucketDistributionId != value)
                {
                    _LoanBucketDistributionId = value;
                    OnPropertyChanged(() => LoanBucketDistributionId);
                }
            }
        }
        ...
        class LoanBucketDistributionValidator : AbstractValidator<LoanBucketDistribution>
        {
            public LoanBucketDistributionValidator()
            {
        ...
        {
            return new LoanBucketDistributionValidator();
        }
    }
}
