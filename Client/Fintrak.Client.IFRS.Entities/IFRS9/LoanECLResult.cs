...
{
    public class LoanECLResult : ObjectBase
    {
        int _ID;
        string _AccountNo;
        string _RefNo;
        ...
        class LoanECLResultValidator : AbstractValidator<LoanECLResult>
        {
            public LoanECLResultValidator()
            {
        ...
        {
            return new LoanECLResultValidator();
        }
    }
}
