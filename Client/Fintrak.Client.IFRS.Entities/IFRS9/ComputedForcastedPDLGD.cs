...
{
    public class ComputedForcastedPDLGD : ObjectBase
    {
        int _ComputedPDId;
        string _Sector_Code;
        int _Type;
        ...
        class ComputedForcastedPDLGDValidator : AbstractValidator<ComputedForcastedPDLGD>
        {
            public ComputedForcastedPDLGDValidator()
            {
        ...
        {
            return new ComputedForcastedPDLGDValidator();
        }
    }
}
