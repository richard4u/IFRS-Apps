...
{
    public class TBillEclComputationResult : ObjectBase
    {
        int _ID;
        string _Refno;
        ...
        class TBillEclComputationResultValidator : AbstractValidator<TBillEclComputationResult>
        {
            public TBillEclComputationResultValidator()
            {
        ...
        {
            return new TBillEclComputationResultValidator();
        }
    }
}
