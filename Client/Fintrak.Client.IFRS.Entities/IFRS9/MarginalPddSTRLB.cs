...
{
    public class MarginalPddSTRLB : ObjectBase
    {
        ...
        class MarginalPddSTRLBValidator : AbstractValidator<MarginalPddSTRLB>
        {
            public MarginalPddSTRLBValidator(){
        ...
        {
            return new MarginalPddSTRLBValidator();
        }
