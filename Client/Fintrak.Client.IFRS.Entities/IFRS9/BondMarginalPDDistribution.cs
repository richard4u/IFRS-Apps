...
{
    public class BondMarginalPDDistribution : ObjectBase
    {
        int _ID;
        string _AccountNo;
        string _Refno;
        ...
        class BondMarginalPDDistributionValidator : AbstractValidator<BondMarginalPDDistribution>
        {
            public BondMarginalPDDistributionValidator()
            {
                //RuleFor(obj => obj._Refno).NotEmpty().WithMessage("Refno is required.");
        ...
        {
            return new BondMarginalPDDistributionValidator();
        }
    }
}
