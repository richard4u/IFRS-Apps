...
{
    public class LGDComptResult : ObjectBase
    {
        ...
        class LGDComptResultValidator : AbstractValidator<LGDComptResult>
        {
            public LGDComptResultValidator(){
        ...
        {
            return new LGDComptResultValidator();
        }
