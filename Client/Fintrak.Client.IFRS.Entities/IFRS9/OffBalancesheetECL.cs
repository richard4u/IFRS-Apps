...
{
    public class OffBalancesheetECL : ObjectBase
    {
        int _obe_Id;
        string _Account_No;
        ...
        class OffBalancesheetECLValidator : AbstractValidator<OffBalancesheetECL>
        {
            public OffBalancesheetECLValidator()
            {
        ...
        {
            return new OffBalancesheetECLValidator();
        }
    }
}
