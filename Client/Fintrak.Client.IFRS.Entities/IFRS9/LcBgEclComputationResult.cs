...
{
    public class LcBgEclComputationResult : ObjectBase
    {
        int _ID;
        string _Refno;
        ...
        class LcBgEclComputationResultValidator : AbstractValidator<LcBgEclComputationResult>
        {
            public LcBgEclComputationResultValidator()
            {
        ...
        {
            return new LcBgEclComputationResultValidator();
        }
    }
}
