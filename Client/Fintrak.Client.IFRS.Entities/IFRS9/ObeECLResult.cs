...
{
    public class ObeECLResult : ObjectBase
    {
        int _ID;
        string _AccountNo;
        string _RefNo;
        ...
        class ObeECLResultValidator : AbstractValidator<ObeECLResult>
        {
            public ObeECLResultValidator()
            {
        ...
        {
            return new ObeECLResultValidator();
        }
    }
}
