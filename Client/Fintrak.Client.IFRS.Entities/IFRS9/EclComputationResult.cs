...
{
    public class EclComputationResult : ObjectBase
    {
        int _ID;
        string _Refno;
        ...
        class EclComputationResultValidator : AbstractValidator<EclComputationResult>
        {
            public EclComputationResultValidator()
            {
        ...
        {
            return new EclComputationResultValidator();
        }
    }
}
