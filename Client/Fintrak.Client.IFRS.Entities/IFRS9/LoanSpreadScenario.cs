...
{
    public class LoanSpreadScenario : ObjectBase
    {
        int _LoanSpreadScenarioId;
        string _RefNo;
        string _AccountNo;
        string _Sector;
        string _Rating;
        ...
        public int LoanSpreadScenarioId
        {
            get { return _LoanSpreadScenarioId; }
            set
            {
                if (_LoanSpreadScenarioId != value)
                {
                    _LoanSpreadScenarioId = value;
                    OnPropertyChanged(() => LoanSpreadScenarioId);
                }
            }
        }
        ...
        class LoanSpreadScenarioValidator : AbstractValidator<LoanSpreadScenario>
        {
            public LoanSpreadScenarioValidator()
            {
        ...
        {
            return new LoanSpreadScenarioValidator();
        }
    }
}
