...
{
    public class LoansECLComputationResult : ObjectBase
    {
        int _ID;
        string _AccountNo;
        string _Refno;
        ...
        class LoansECLComputationResultValidator : AbstractValidator<LoansECLComputationResult>
        {
            public LoansECLComputationResultValidator(){
        ...
        {
            return new LoansECLComputationResultValidator();
        }
