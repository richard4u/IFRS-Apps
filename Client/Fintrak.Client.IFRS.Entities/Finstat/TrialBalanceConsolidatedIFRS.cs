...
{
    public class TrialBalanceConsolidatedIFRS : ObjectBase
    {
        int _TrialBalanceId;
        string _BranchCode;
        string _GLCode;
        ...
        class TrialBalanceConsolidatedIFRSValidator : AbstractValidator<TrialBalanceConsolidatedIFRS>
        {
            public TrialBalanceConsolidatedIFRSValidator()
            {
        ...
        {
            return new TrialBalanceConsolidatedIFRSValidator();
        }
    }
}
