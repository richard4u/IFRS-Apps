...
{
    public class GLMappingMgt : ObjectBase
    {
        int _GLMappingMgtId;
        string _GLCode;
        ...
        public int GLMappingMgtId
        {
            get { return _GLMappingMgtId; }
            set
            {
                if (_GLMappingMgtId != value)
                {
                    _GLMappingMgtId = value;
                    OnPropertyChanged(() => GLMappingMgtId);
                }
            }
        }
        ...
        class GLMappingMgtValidator : AbstractValidator<GLMappingMgt>
        {
            public GLMappingMgtValidator()
            {
        ...
        {
            return new GLMappingMgtValidator();
        }
    }
}
