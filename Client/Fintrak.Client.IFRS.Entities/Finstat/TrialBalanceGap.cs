...
{
    public class TrialBalanceGap : ObjectBase
    {
        int _TrialBalanceGapId;
        string _BranchCode;
        string _GLCode;
        string _Description;
        ...
        public int TrialBalanceGapId
        {
            get { return _TrialBalanceGapId; }
            set
            {
                if (_TrialBalanceGapId != value)
                {
                    _TrialBalanceGapId = value;
                    OnPropertyChanged(() => TrialBalanceGapId);
                }
            }
        }
        ...
        class TrialBalanceGapValidator : AbstractValidator<TrialBalanceGap>
        {
            public TrialBalanceGapValidator()
            {
        ...
        {
            return new TrialBalanceGapValidator();
        }
    }
}
