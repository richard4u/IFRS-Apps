...
{
    public class RevenueGLMapping : ObjectBase
    {
        int _GLMappingId;
        string _GLCode;
        ...
        class RevenueGLMappingValidator : AbstractValidator<RevenueGLMapping>
        {
            public RevenueGLMappingValidator()
            {
        ...
        {
            return new RevenueGLMappingValidator();
        }
    }
}
