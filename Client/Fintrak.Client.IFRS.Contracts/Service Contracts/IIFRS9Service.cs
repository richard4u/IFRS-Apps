...
namespace Fintrak.Client.IFRS.Contracts
{
    ...
    public interface IIFRS9Service : IServiceContract
    {
        ...
        [OperationContract]
        [TransactionFlow(TransactionFlowOption.Allowed)]
        IfrsBondLGD UpdateIfrsBondLGD(IfrsBondLGD ifrsInvestment);
        ...
        [OperationContract]
        [TransactionFlow(TransactionFlowOption.Allowed)]
        IfrsMarginalPDByScenerio UpdateIfrsMarginalPDByScenerio(IfrsMarginalPDByScenerio ifrsmarginalpdscenario);
      ...
      //  IfrsLgdProjections GetIfrsLgdProjections(int Id);
        ...
        [OperationContract]
        [FaultContract(typeof(NotFoundException))]
        CashFlowTB[] GetCashFlowTBBySearch(string searchParam, string path);
        ...
        [OperationContract]
        [TransactionFlow(TransactionFlowOption.Allowed)]
        Harmortization UpdateHarmortization(Harmortization[] conditionalpd);
