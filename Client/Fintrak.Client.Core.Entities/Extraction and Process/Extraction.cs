...
namespace Fintrak.Client.Core.Entities
{
    public class Extraction : ObjectBase
    {
        ...
        public string NeedArchiveAction
        {
            get { return _NeedArchiveAction; }
            set
            {
                if (_NeedArchiveAction != value)
                {
                    _NeedArchiveAction = value;
                    OnPropertyChanged(() => NeedArchiveAction);
                }
            }
        }
