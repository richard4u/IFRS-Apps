...
{
    public class CheckifrsDataAvailability : ObjectBase
    {
        int _CheckDataId;
        int _RecCount;
        string _Package;
        ...
        class CheckifrsDataAvailabilityValidator : AbstractValidator<CheckifrsDataAvailability>
        {
            public CheckifrsDataAvailabilityValidator()
            {
        ...
        {
            return new CheckifrsDataAvailabilityValidator();
        }
    }
}
